export default {
  ...
  events: {
    ...
    hostedBy: ' بتنظيم من ',
    hostedByJOSA: 'بتنظيم من الجمعية الأردنية للمصدر المفتوح',
    happening: 'يحدث الآن',
    joinCall:
  ...
  // Footer
  copyright: {
    info: 'محتوى هذا الموقع مرخص برخصة المشاع الإبداعي',
    creative: 'نسب المصنف - الترخيص بالمثل 3.0 دولي (CC-BY-SA 3.0)،',
    except: 'إلا إذا ورد خلاف ذلك.',
  },
  careers: {
    all: 'جميع الوظائف',
    publishDate: 'تاريخ النشر',
